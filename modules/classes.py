...
from modules.tcx_processing import parse_garmin_tcx, clean_garmin_tcx_data, extract_running_intervals
...
class GarminDB:
    ...
    def connect(self):
        self._con = pg2.connect(database=self._db_name, user=self._username, 
